...
This is a cross-platform, 100% ES6 implementation of the Unix `source` command.

```bash
npm install cash-source -g
```

This will install `source` globally in your system path.
...
- [cash-source](https://npmjs.com/package/cash-source)
